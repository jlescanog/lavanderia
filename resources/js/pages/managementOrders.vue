            ...
            >
                        ...
                        <div class="card-body w-100 p-0 pt-3 container">
                            ...
                            >
                                ...
                                >
                                    <label
                                        type="text"
                                        class="input-group-text border border-0 bg-transparent fw-medium text-reset ps-3"
                                        role="button"
                                    >
                                        Total Prendas
                                    </label>
                                    <label
                                        type="number"
                                        class="form-control border border-0 bg-transparent fw-medium text-reset text-center"
                                        role="button"
                                ...
                                >
                                    <label
                                        type="text"
                                        class="input-group-text border border-0 bg-transparent fw-medium text-reset ps-4"
                                        role="button"
                                    >
                                        Edredones
                                    </label>
                ...
                >
                    ...
                    >
                        ...
                        <li
                            class="list-group-item border p-0 show border-secondary border-2 rounded"
                        ...
                        >
                            ...
                            >
                                ...
                                <input
                                    ...
                                    type="number"
                                    id="clarosInput"
                                    class="text-center border border-0 ps-2"
                                    readonly
                                    disabled
                                    style="width: 4rem"
                                />
                    ...
                    <div
                        v-if="orden.edredones > 0"
                        class="input-group border border-secondary rounded border-3"
                    >
                        <label
                            type="text"
                            class="form-control border-0"
